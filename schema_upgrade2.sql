...
-- Run this ONCE manually in phpMyAdmin on your own database (from config.php) only
-- if you have disabled auto_migrate (or to apply it ahead of deploying the files).

-- Votes (likes/dislikes) — works for both pastes and user profiles
...
-- Comments — one table for both pastes and profiles
